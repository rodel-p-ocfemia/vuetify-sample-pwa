<template>
 <div id="app">
    <v-app light>
      <v-toolbar fixed flat :class="toolbarcolor" style="color:white;">
          <v-toolbar-title>Title</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-toolbar-items>
              <v-btn flat color="white">Link One</v-btn>
              <v-btn flat color="white">Link Two</v-btn>
              <v-btn flat @click="dialog=true" color="white">Login</v-btn>
          </v-toolbar-items>
      </v-toolbar>
      <main>
        <section>
          <!--<v-parallax src="https://github.com/vwxyzjn/vuetify-parallax-starter2/raw/master/src/assets/background1.jpg" height="380">-->
          <v-parallax :src="require('@/assets/background1.jpg')" height="380">  
            <v-layout column align-center justify-center>
              ...
              <v-btn light large class="teal lighten-2 white--text" to="/">Get Started</v-btn>
            </v-layout>
          </v-parallax>
              ...
              <v-flex xs12>
                <v-card class="elevation-0">
                  ...
                  <v-card-text>
                    ...
                    maximus sed. Nulla imperdiet semper molestie. Morbi massa odio, condimentum sed ipsum ac, gravida 
...
<script>
import LoginDialog from '@/components/LoginDialog2'
export default {
     data () {
         return {
             topvar: true,
